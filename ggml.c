...
// 323 040 000
// 270 000 000
    printf("P=%d N=%d D=%d ir0=%d ir1=%d scale = %f nek1=%d\n", P, N, D, ir0, ir1, scale, nek1 );
...
struct ggml_opt_params ggml_opt_default_params(enum ggml_opt_type type) {
    ...
    switch (type) {
        case GGML_OPT_ADAM:
            {  printf( "ggml_opt_default_params GGML_OPT_ADAM\n");
        ...
        case GGML_OPT_LBFGS:
            {  printf( "ggml_opt_default_params GGML_OPT_LBFGS\n");
                result = (struct ggml_opt_params) {
                    .type      = GGML_OPT_LBFGS,
                    .n_threads = 1,
                    .past      = 0,
